    ...
    return (
        <div className="content-area">
            ...
            <div className="max-w-2xl mx-auto">
                <h1 className="page-title mb-[var(--space-8)]">inställningar</h1>

                <div className="card mb-[var(--space-6)]">
                    <h2 className="text-lg font-bold mb-[var(--space-4)]">aviseringar</h2>
                    <div className="stack" style={{ gap: "var(--space-4)" }}>
                        <div className="flex items-center justify-between p-[var(--space-3)] bg-secondary-alt rounded border border-subtle">
                            <div>
                        ...
                        <div className="flex items-center justify-between p-[var(--space-3)] bg-secondary-alt rounded border border-subtle opacity-50">
                            <div>
                ...
                <div className="card">
                    <h2 className="text-lg font-bold mb-[var(--space-4)]">utseende</h2>
                    <div className="stack" style={{ gap: "var(--space-4)" }}>
                        <div className="flex items-center justify-between p-[var(--space-3)] bg-secondary-alt rounded border border-accent">
                            <div>
                ...
                <p className="mt-[var(--space-8)] text-center text-xs text-muted uppercase tracking-widest">
